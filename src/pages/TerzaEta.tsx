    ...
    <div className="pt-32 min-h-screen bg-[#97CCEA]/10 px-6">
      <div className="max-w-4xl mx-auto pb-32 text-center">
        <Reveal>
          ...
          <h1 className="text-6xl md:text-9xl italic mb-16 leading-none">Terza Età</h1>
          <p className="text-xl md:text-2xl max-w-2xl mx-auto opacity-70 leading-relaxed font-serif italic mb-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 text-left">
          <Reveal>
            <div className="bg-white p-12 border border-black/5">
              <h3 className="text-2xl font-serif italic mb-6">Incontri di Lettura</h3>
          ...
          <Reveal>
            <div className="bg-white p-12 border border-black/5">
              <h3 className="text-2xl font-serif italic mb-6">Momenti di Pace</h3>
              <p className="opacity-70 leading-relaxed">
